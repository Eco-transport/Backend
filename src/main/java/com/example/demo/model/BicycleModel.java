...
public class BicycleModel implements Serializable {
    ...
    @SequenceGenerator( name = "BICYCLE_BICYCLEID_GENERATOR", 
        sequenceName = "public.bicycle_bicycle_id_seq", allocationSize = 1 )
    ...
    @Column(name = "bicycle_vendor", nullable = true)
    private String vendor;

    @Column(name = "bicycle_stock", nullable = false)
    private Integer stock;

    @Column(name = "bicycle_buy_price", nullable = true)
