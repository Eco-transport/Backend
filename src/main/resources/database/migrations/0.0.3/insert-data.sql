...
-- Estacion Data --
-- ----------- --
INSERT INTO "bdEcotransport"."public"."estacion" (station_id, station_name,station_address,station_phone,station_open_time,station_close_time,station_city,station_available,station_inventory)
    VALUES (1, 'Banderas', 'Portal Banderas sotano','(310) 558 4585','7:00 am','6:00 pm','Bogota','30','30');
INSERT INTO "bdEcotransport"."public"."estacion" (station_id, station_name,station_address,station_phone,station_open_time,station_close_time,station_city,station_available,station_inventory)
    VALUES (2, 'Suba', 'Cra 116 # 127 - 45','(315) 444 4585','7:00 am','6:00 pm','Bogota','15','15');
INSERT INTO "bdEcotransport"."public"."estacion" (station_id, station_name,station_address,station_phone,station_open_time,station_close_time,station_city,station_available,station_inventory)
    VALUES (3, 'Soacha', 'Cra 25 # 1 - 45','(317) 555 4585','7:00 am','6:00 pm','Soacha','50','50');
